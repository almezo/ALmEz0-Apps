...
def generate_icons():
    ...
    for folder, sizes in DENSITIES.items():
        ...
        # 1. Legacy Squircle/Square Launcher (ic_launcher.png) - Large, bold, no green border
        canvas_leg = Image.new('RGBA', (leg_size, leg_size), BG_COLOR)
        logo_leg_sz = int(leg_size * 0.95)
        ...
        logo_round_sz = int(leg_size * 0.74)
        ...
        # Android adaptive canvas is 108dp, safe area is 72dp (66.6% - 74%)
        # Large and prominent inside the squircle mask
        canvas_fg = Image.new('RGBA', (fg_size, fg_size), (0, 0, 0, 0))
        logo_fg_sz = int(fg_size * 0.72)
    ...
    print("All Android launcher icons generated successfully without green border!")
