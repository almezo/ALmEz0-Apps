...
/**
 * خريطة أكواد السيرفرات، منقولة حرفياً من handleServerCode في splayer.js (وهي الخريطة التي
 * يستخدمها المشغل فعلياً). ملاحظة: servers.json يذكر هوستاً مختلفاً للكود 002، والمعتمد هنا
...
public final class Servers {
    ...
    static {
        ...
        add("003", "http://mar10.sbs", "سيرفر مارفل", R.drawable.srv_marvel);
        ...
        // سيرفر الاختبار المحلي: يوجد صنفه في مجلد debug فقط، فلا يظهر هذا الكود في نسخة الإصدار
        try {
            Class<?> dbg = Class.forName("com.almezo.servers.nat.DebugServers");
            String[] t = (String[]) dbg.getMethod("testServer").invoke(null);
            if (t != null) add(t[0], t[1], t[2], R.drawable.almezo_logo);
